...
export const PLANES = {
  ...
  empresa: {
    key: "empresa", nombre: "Empresa", precioUSD: 30,
  ...
  estudio: {
    key: "estudio", nombre: "Estudio", precioUSD: 55,
  ...
  agencia: {
    key: "agencia", nombre: "Agencia", precioUSD: 90,
  ...
  agencia_pro: {
    key: "agencia_pro", nombre: "Agencia Pro", precioUSD: 150,
